...
class RGBT234Dataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_info):
        ...
        frames_t = [os.path.join(sequence_path, 'infrared', img) for img in img_list_i]
        # Convert gt
        ...
        return Sequence_RGBT(sequence_info['name'], frames_v, frames_t, 'rgbt234', ground_truth_rect)
