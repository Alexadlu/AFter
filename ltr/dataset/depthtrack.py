...
class DepthTrack(BaseVideoDataset):
    ...
    def get_sequence_info(self, seq_id):
        ...
        # myadd：针对depthtrack/train/toy07_indoor_320/序列的groundtruth和图片数量不匹配问题
        if len(os.listdir(os.path.join(seq_path, 'color'))) != bbox.shape[0]:
            bbox = bbox[:len(os.listdir(os.path.join(seq_path, 'color')))]
