...
#
    ...
    net = tompnet.tompnet50_rgbt(filter_size=settings.target_filter_sz, backbone_pretrained=True, head_feat_blocks=0,
    ...
    optimizer = optim.AdamW([
        ...
        {'params': actor.net.head.modals_fusion.parameters(), 'lr': lr_w*2e-4},
